  ...
  return (
    <TimeBackground>
      <div className="px-4 pt-12 pb-32 space-y-6 md:px-0 md:pt-8 md:pb-12 md:space-y-8">
        ...
        {/* HERO */}
        <div
          className="rounded-3xl p-5 relative overflow-hidden animate-fade-up"
          style={{
        ...
        >
          ...
          <div className="relative flex items-start justify-between mb-5">
            <div>
              ...
              <h1 className="text-lg font-bold leading-tight mt-0.5" style={{ color: '#fff' }}>
                {greeting} 👋
              </h1>
            </div>
          ...
          <div className="relative flex items-center justify-center gap-6">
            ...
            <div className="flex flex-col gap-3">
              <div>
                ...
                <p className="text-3xl font-black leading-none mt-0.5" style={{ color: '#fff' }}>
                  {completedToday}
