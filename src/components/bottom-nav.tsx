...
export function BottomNav() {
  ...
  return (
    <nav
      ...
      style={{
        background: 'oklch(0.09 0.04 238 / 92%)',
        borderTop: '1px solid oklch(0.75 0.12 210 / 14%)',
        ...
        {navItems.map(({ icon: Icon, href, labelHe, labelEn }) => {
          ...
          return (
            <button
              ...
              style={isActive ? {
                background: 'oklch(0.75 0.17 205 / 12%)',
              } : {}}
            >
              {/* Active top bar */}
              {isActive && (
              ...
              <Icon
                ...
                style={{ color: isActive ? 'oklch(0.75 0.17 205)' : 'oklch(0.55 0.05 230)' }}
              />
              <span
                className="text-[10px] font-semibold transition-all"
                style={{ color: isActive ? 'oklch(0.75 0.17 205)' : 'oklch(0.50 0.05 230)' }}
              >
